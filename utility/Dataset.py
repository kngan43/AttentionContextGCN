...
import os
from Tool import randint_choice, df_to_positive_dict, save_dict_to_file, load_dict_from_file, csr_to_user_dict
import pandas as pd
...
class Dataset(object):
    def __init__(self, conf = None, logger = None):
        ...
        self.separator = [',', '-']
        self.dataset_name = 'Yelp-OH' 
        self.dataset_folder = '/Users/kerryngan/neu/7500_dl/final_project/checkpoint1/GCM/dataset/Yelp-OH/'
        ...
        data_splitter = GivenData(self.dataset_name, self.dataset_folder, data_format, self.separator, self.logger)
