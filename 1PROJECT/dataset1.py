...
class DataInfo(object):
    def __init__(self):
        ...
        self.train_matrix, self.test_matrix, self.all_data_dict, self.side_info, self.num_items = self.load_data()
...
user_input_val, context_input_val, item_input_val, labels_val = DataInfo()._get_pointwise_all_data_context( phase='valid')

print(len(labels_val))
print(len(user_input_val))
print(len(context_input_val))